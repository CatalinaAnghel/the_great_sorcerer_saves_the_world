...
public class SorcererCircle{
	...
	/**
	 * This is the action made by the threads when 
	 * they leave the barrier
	 */
	static Runnable barrierAction = new Runnable() {
	    public void run() {
	        System.out.println("The demons woke up. ");
	    }
	};
	...
	public static void main(String[] args) throws UnknownHostException, IOException {
		...
		CyclicBarrier cyclicBarrier[] = new CyclicBarrier[noCovens];
		for(int iterator = 0; iterator < noCovens; iterator++) {
			Integer noDemons = random.nextInt(400) + 100;
			cyclicBarrier[iterator] = new CyclicBarrier(noDemons, barrierAction);
