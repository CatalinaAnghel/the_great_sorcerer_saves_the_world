...
public class Coven extends Thread{
	...
	/**
	 * This is the barrier implemented by me.
	 */
	protected MyCyclicBarrier cyclicBarrier;
	 ...
	 * @param cb MyCycliBarrier - the barrier used to wake up the sleeping demons
	 */
	public Coven(Integer id, Integer capacity, String[] types, MyCyclicBarrier cb) {
